...
hi CursorLineNr guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
...
hi Statement guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
hi PreProc guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
...
hi Type guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
...
hi javaScriptFunction guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
...
hi Directory guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
hi Title guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
hi markdownHeadingDelimiter guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
hi markdownHeadingRule guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold
