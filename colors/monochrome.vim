...
hi CursorLineNr guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi Statement guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi PreProc guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi Type guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Function guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi javaScriptFunction guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi elixirDelimiter guifg=#778899 ctermfg=67 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Search guifg=DarkGray ctermfg=15 guibg=#778899 ctermbg=67 gui=NONE cterm=NONE term=NONE
hi Visual guifg=DarkGray ctermfg=15 guibg=#778899 ctermbg=67 gui=NONE cterm=NONE term=NONE
hi NonText guifg=DarkGray ctermfg=248 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Directory guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Title guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi markdownHeadingDelimiter guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi markdownHeadingRule guifg=DarkGray ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi Pmenu guifg=DarkGray ctermfg=15 guibg=#778899 ctermbg=67 gui=NONE cterm=NONE term=NONE
